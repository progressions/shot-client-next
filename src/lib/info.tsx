  ...
  character: {
    ...
    content: (
      <>
        ...
        narrative by the GM’s deft hand. These are the heroes, villains, and
        enigmatic figures whose actions shape the chaotic tapestry of the{" "}
  ...
  "chi war": {
    ...
    content: (
      <>
        ...
        . It’s a high-stakes struggle of martial prowess, mystical power, and
        cunning strategy, where every victory shifts the balance of{" "}
  ...
  faction: {
    ...
    content: (
      <>
        ...
        vision, whether it’s noble, nefarious, or something in between. From
        shadowy cabals to heroic brotherhoods,{" "}
  ...
  category: {
    ...
    content: (
      <>
        ...
        world, grouping them by their function or nature. Whether it’s a blazing
        array of firearms or a suite of mystical spells,{" "}
  ...
  path: {
    ...
    content: (
      <>
        ...
        ’s arsenal. Whether mastering a specific <InfoLink info="Martial Art" />{" "}
        or honing a unique <InfoLink info="Magic" />
  ...
  concealment: {
    ...
    content: (
      <>
        ...
        ’s subtlety, the ease with which it can be hidden from prying eyes. A
        low <InfoLink info="Concealment" /> score means a blade or pistol can be
        tucked away unnoticed, perfect for assassins or spies slipping through
        the shadows of the <InfoLink info="Chi War" />
        ’s deadly intrigues.
      </>
    ),
  },
  ...
  user: {
    ...
    content: (
      <>
        ...
        <InfoLink href="/characters" info="Character" />
        ’s journey, <InfoLink href="/users" info="Users" /> shape the chaos,
        intrigue, and heroism that define the <InfoLink info="Chi War" />.
      </>
    ),
  },
  "martial art": {
    ...
    content: (
      <>
        ...
        warrior’s body into a living <InfoLink href="/weapons" info="Weapon" />,
  ...
  "av gun": {
    ...
    content: (
      <>
        ...
        <InfoLink href="/characters" info="Character" />
        ’s mastery of firearms, from sleek pistols to thunderous shotguns. This
        skill turns a mere <InfoLink href="/weapons" info="Weapon" /> into an
        extension of their will, delivering precise, devastating strikes that
  ...
  "av defense": {
    ...
    content: (
      <>
        ...
        <InfoLink href="/characters" info="Character" />
        ’s ability to evade or withstand attacks, a critical shield in the chaos
        of a <InfoLink href="/fights" info="Fight" />. An attacker must roll an
        Action Result equal to or greater than a{" "}
        <InfoLink href="/characters" info="Character" />
  ...
  "av toughness": {
    ...
    content: (
      <>
        ...
        <InfoLink href="/characters" info="Character" />
        ’s raw resilience, their ability to shrug off pain and keep fighting. By
        reducing the Smackdown taken from a hit, <InfoLink info="Toughness" />{" "}
        allows warriors to endure the fiercest assaults and stand tall in the
        relentless storm of the <InfoLink info="Chi War" />.
      </>
    ),
  },
  "av speed": {
  ...
  "av fortune": {
    ...
    content: (
      <>
        ...
        <InfoLink href="/characters" info="Character" />
        ’s luck, a subtle force that tips fate in their favor. By spending a{" "}
        <InfoLink info="Fortune" /> point, they can add a single non-exploding
  ...
  "av genome": {
    ...
    content: (
      <>
        ...
        <InfoLink href="/characters" info="Character" />
        ’s genetic mutations, the unique traits that grant them extraordinary
        abilities. From superhuman strength to unnatural senses, these gifts set
        them apart in the <InfoLink info="Chi War" />, making them both feared
        and coveted by their enemies.
      </>
    ),
  },
  "av scroungetech": {
  ...
  "archetype: redeemed pirate": {
    ...
    content: (
      <>
        ...
        <InfoLink info="Chi War" />
        ’s dangers, their past sins fueling their quest for redemption across
        the <InfoLink href="/junctures" info="Junctures" />.
      </>
    ),
  },
  ...
  wealth: {
    ...
    content: (
      <>
        ...
        <InfoLink href="/characters" info="Character" />
        ’s access to resources, from cold hard cash to valuable connections or
        rare artifacts. In the Feng Shui universe, <InfoLink info="Wealth" />{" "}
