    ...
    <Box sx={{ textAlign: 'center' }}>
      ...
      <Box sx={{ mb: 4 }}>
        <Typography variant="body1" sx={{ mb: 2, lineHeight: 1.6 }}>
          You've mastered the basics of Chi War by creating your first campaign, characters, 
          factions, fights, parties, and sites. You're now ready to dive into epic adventures!
        </Typography>
        
        <Stack direction="row" spacing={1} justifyContent="center" flexWrap="wrap" sx={{ mb: 3 }}>
          {[
            'Campaign', 'Character', 'Faction', 'Fight', 'Party', 'Site'
          ].map((item) => (
            <Chip 
              key={item}
              icon={<Check />}
      ...
      >
        ...
        <Typography variant="body2" color="text.secondary" sx={{ textAlign: 'left' }}>
          • <strong>Create more characters:</strong> Build your cast of heroes and villains<br/>
          • <strong>Start fights:</strong> Use the initiative system to run combat encounters<br/>
          • <strong>Organize parties:</strong> Group characters for adventures and missions<br/>
          • <strong>Build your world:</strong> Add more factions, sites, and campaign details<br/>
          • <strong>Have fun:</strong> You're ready to play Feng Shui 2!
        </Typography>
      </Box>
