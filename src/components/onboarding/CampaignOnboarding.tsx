...
export const CampaignOnboarding: React.FC<CampaignOnboardingProps> = ({ currentPath }) => {
      ...
      <Stack direction="row" alignItems="center" spacing={2} sx={{ mb: 2 }}>
        ...
        <Box flex={1}>
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mt: 0.5 }}>
            {campaignMilestone.description} Click the button below to get started!
          </Typography>
        </Box>
      </Stack>
      ...
      {isOnRelevantPage && (
        ...
        >
          <Typography variant="body2" color="text.secondary" sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            💡 <strong>Tip:</strong> Look for the floating action button (⊕) at the bottom right of the page to create your campaign!
          </Typography>
        </Box>
      )}
    </Box>
