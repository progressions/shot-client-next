    ...
    >
      ...
      >
        ...
        <Typography>
          ...
          flow of energy produces powerful <InfoLink info="Chi" /> for those who
          are attuned to it. A Feng Shui Site belongs to a{" "}
        ...
        <Box sx={{ mt: 2 }}>
          <Typography sx={{ mb: 2 }}>
            A <InfoLink href="/sites" info="Feng Shui Site" /> belongs to a
            certain <InfoLink href="/factions" info="Faction" />, which
            increases its power and influence in the Chi War.
          </Typography>
          <FactionAutocomplete
            value={faction_id || ""}
