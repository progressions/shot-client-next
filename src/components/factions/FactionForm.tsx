...
import type { EditorChangeEvent, Faction } from "@/types/types"
...
export default function FactionForm({ open, onClose, onSave, initialFormData, title, existingImageUrl }: FactionFormProps) {
