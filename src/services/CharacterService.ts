import type { Juncture, Faction, CharacterJson, Vehicle, Weapon, SkillValue, Character } from "@/types"
import { defaultJuncture, defaultFaction, defaultCharacter, DescriptionValues, DescriptionKeys } from "@/types"
...
const CharacterService = {
  ...
  chain: function(character: Character, calls: Array<[string, object[]]>): Character {
    let char = character
