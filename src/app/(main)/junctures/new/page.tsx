// app/junctures/new/page.tsx
// Renders the junctures list with the create form drawer open
...
export const metadata = {
  title: "New Juncture - Chi War",
}

export default async function NewJuncturePage({
  searchParams,
}: {
